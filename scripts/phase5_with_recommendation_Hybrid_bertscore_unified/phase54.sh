...
SOURCE_DIR="/root/autodl-tmp/MovieRecommendationRAG/results/phase5_with_recommendations_v4&KG_Path"
OUTPUT_DIR="/root/autodl-tmp/MovieRecommendationRAG/results/phase5_with_recommendation_Hybrid_bertscore_unified"
LOG_DIR="/root/autodl-tmp/MovieRecommendationRAG/logs/phase5_with_recommendation_Hybrid_bertscore_unified"
