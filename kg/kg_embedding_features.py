...
def main():
    ...
    splits = [
        ("data/processed/train_recall_candidates.csv", "data/kg/kg_emb_features_train_recall.csv"),
        ("data/processed/val_recall_candidates.csv", "data/kg/kg_emb_features_val_recall.csv"),
